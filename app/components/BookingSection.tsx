...
function submitBooking(event: FormEvent<HTMLFormElement>) {
  ...
  window.location.href = "mailto:abhinikam47@gmail.com?subject=Booking%20Enquiry%20%E2%80%94%20DJ%20NO-One";
}

export function BookingSection() {
  return (
    <section className="booking" id="booking">
      <div className="booking-portrait"><img src="/images/portrait-booking-clean.png" alt="DJ NO-One" loading="lazy" /></div>
      ...
      <footer>
        <div className="footer-brand" aria-label="DJ NO-One">
